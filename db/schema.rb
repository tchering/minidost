...
ActiveRecord::Schema[7.1].define(version: 20_241_128_124_722) do
  ...
  create_table 'tasks', force: :cascade do |t|
    ...
    t.index %w[taskable_id taskable_type], name: 'index_tasks_on_taskable_id_and_taskable_type'
    t.index %w[taskable_type taskable_id], name: 'index_tasks_on_taskable'
  end
